...
var window_background = "#ccccff"; // the color of the pop-up window
var window_border = "#9999cc";// the border color of pop-up window
...
document.write('<input style="width: auto" type="button" value="Search this page..."'
	+ ' onclick="show();">');
