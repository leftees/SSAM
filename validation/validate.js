...
function checkEnable() {
  if (document.getElementById("activate")== 'disabled') // some logic to determine if it is ok to go
...
function validateInput(strValidateStr, objValue, strError)
{
    ...
    case "alphanumeric":
        {
            ret = TestInputType(objValue, "[^A-Za-z0-9_.-]", strError, objValue.name + ": Only alpha-numeric characters allowed ");
            break;
        }
    case "alnum_s":
